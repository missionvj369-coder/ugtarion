-- Migration: Add password strength validation to register_user_with_password
-- Date: 2026-07-22

-- Drop existing function with TEXT dob parameter
...
BEGIN
    ...
    -- Insert the profile (cast dob from text to date)
